...
final class Controller {
    ...
    /** Make white as manual player. */
    private void doManualWhite(Matcher unused) {
        _white = _manualPlayerTemplate.create(WHITE, this);
    }

    /** Make black as manual player. */
    ...
    /** Make move on the board and output winner if there is one. */
    private void doMove(Matcher unused) {
        _board.makeMove(Move.mv(movecommand));
    ...
    /** A string containing move command. */
